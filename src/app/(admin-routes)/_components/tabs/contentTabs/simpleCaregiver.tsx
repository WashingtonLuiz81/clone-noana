...
import SimpleCaregiverDetail from '../../sections/simpleCaregiver/actions/simpleCaregiverDetails'
import SimpleCaregiverEdit from '../../sections/simpleCaregiver/actions/simpleCaregiverEdit'
import SimpleCaregiverRegistration from '../../sections/simpleCaregiver/simpleCaregiverRegistration'
      ...
      >
        ...
        >
          {isVisibleSection === 'monitor' && (
            <SimpleCaregiverRegistration closeSection={setIsVisibleSection} />
          )}
          {isVisibleSection === 'view' && (
            <SimpleCaregiverDetail
